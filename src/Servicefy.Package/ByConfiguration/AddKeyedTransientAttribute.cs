...
public static class AddKeyedTransientAttribute
{
    public static string Value(string namespacedName)
    {
        return $$"""
             ...
             {
                 /// <summary>
                 /// Registers the decorated class as a <b>keyed Transient</b> service against the explicit
                 ...
                 /// </exception>
                 /// <seealso href="https://elixneto.github.io/Servicefy/byconfiguration/add-keyed-transient">AddKeyedTransient — Servicefy docs</seealso>
                 ...
                 /// <summary>
                 /// Registers the decorated class as a <b>keyed Transient</b> service.
