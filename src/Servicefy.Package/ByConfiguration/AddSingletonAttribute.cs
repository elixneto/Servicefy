...
public static class AddSingletonAttribute
{
    public static string Value(string namespacedName)
    {
        return $$"""
             ...
             {
                 /// <summary>
                 /// Registers the decorated class with a <b>Singleton</b> lifetime against the explicit
                 ...
                 /// </exception>
                 /// <seealso href="https://elixneto.github.io/Servicefy/byconfiguration/add-singleton">AddSingleton — Servicefy docs</seealso>
                 ...
                 /// <summary>
                 /// Registers the decorated class with a <b>Singleton</b> lifetime.
