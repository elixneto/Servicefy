...
public static class AddTransientAttribute
{
    public static string Value(string namespacedName)
    {
        return $$"""
             ...
             {
                 /// <summary>
                 /// Registers the decorated class with a <b>Transient</b> lifetime against the explicit
                 ...
                 /// </exception>
                 /// <seealso href="https://elixneto.github.io/Servicefy/byconfiguration/add-transient">AddTransient — Servicefy docs</seealso>
                 ...
                 /// <summary>
                 /// Registers the decorated class with a <b>Transient</b> lifetime.
