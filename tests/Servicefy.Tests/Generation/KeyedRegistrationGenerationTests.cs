...
public class KeyedRegistrationGenerationTests
{
    ...
    [Fact]
    public void AddKeyedScoped_MultipleInterfaces_NoExplicitType_RegistersAllInterfaces()
    {
        var source = """
            using TestAssembly;
            namespace TestAssembly
        ...
        Assert.NotNull(generatedSource);
        Assert.Contains("services.AddKeyedScoped<global::TestAssembly.IServiceA, global::TestAssembly.MyService>(\"myKey\");", generatedSource);
        Assert.Contains("services.AddKeyedScoped<global::TestAssembly.IServiceB, global::TestAssembly.MyService>(\"myKey\");", generatedSource);
    }
}
